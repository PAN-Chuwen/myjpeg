...
# image_padded.show()
# image_padded = image_padded.convert('RGB')
# image_padded.save('ti10_padded.png')
...
# npmatrix_restored = restore_img_from_padding(Y_padded,Cb_padded,Cr_padded,rows,cols)
# image_restored = Image.fromarray(npmatrix_restored,'YCbCr')
# image_restored.show()
# image_restored = image_restored.convert('RGB')
# image_restored.save('ti10_restored.png')
